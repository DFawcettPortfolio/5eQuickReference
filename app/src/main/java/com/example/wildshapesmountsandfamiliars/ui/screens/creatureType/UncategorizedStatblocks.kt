...
val findSteedCamel = registerUncategorizedStatBlock(
    StatBlock(
        ...
        description = null,
        tags = "telepathic",
        source = "Find Steed; Player's Handbook (SRD)"
    )
)
...
val cloneStatblock = registerUncategorizedStatBlock(
    StatBlock(
        ...
        description = null,
        tags = null,
        source = "Clone; Player's Handbook (SRD)"
    )
)
...
val unseenServantStatBlock = registerUncategorizedStatBlock(
    StatBlock(
        ...
        description = null,
        tags = "none",
        source = "Unseen Servant; Player's Handbook (SRD)"
    )
)
...
val phantomSteedStatBlock = registerUncategorizedStatBlock(
    StatBlock(
        ...
        description = null,
        tags = "none",
        source = "Phantom Steed; Player's Handbook (SRD)"
    )
)
...
val guardianOfFaithStatBlock = registerUncategorizedStatBlock(
    StatBlock(
        ...
        description = null,
        tags = "none",
        source = "Guardian of Faith;  Player's Handbook (SRD)"
    )
)

val arcaneHandStatBlock = registerUncategorizedStatBlock(
    StatBlock(
        name = "Arcane Hand (Arcane Hand)",
        size = "Large",
        type = "force",
        alignment = null,
        armorClass = "20",
        ...
        description = null,
        tags = "cc - grappled",
        source = "Arcane Hand; Player's Handbook (SRD)"
    )
)